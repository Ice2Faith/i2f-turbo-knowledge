...
echo [script exec]: lib\windows\mysqldump.exe -h %bak_host% -u%bak_user% -p%bak_password% --no-tablespaces --skip-extended-insert --single-transaction --quick %bak_db% %bak_table%  ^>  "%bak_file%"
..\lib\windows\mysqldump.exe -h %bak_host% -u%bak_user% -p%bak_password% --no-tablespaces --skip-extended-insert --single-transaction --quick %bak_db% %bak_table%  >  "%bak_file%"
